...
import { LessonData, QuizData, AssignmentData } from "@/types/lesson";

export const lessonLessons: LessonData[] = [
  {
    id: "1",
    moduleId: "2",
    lessonId: "1",
...
export const lessonQuizzes: QuizData[] = [
  {
    id: "1",
    moduleId: "2",
    lessonId: "1",
...
export const lessonAssignments: AssignmentData[] = [
  {
    id: "1",
    moduleId: "2",
    lessonId: "1",
