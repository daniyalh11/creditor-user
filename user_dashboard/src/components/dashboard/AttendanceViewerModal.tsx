...
const attendanceByDate: Record<string, { status: "present" | "absent"; topic: string }> = {
...
export function AttendanceViewerModal({ isOpen, onClose }: AttendanceViewerModalProps) {
