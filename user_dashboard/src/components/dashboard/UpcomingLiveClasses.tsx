...
export function UpcomingLiveClasses() {
  const [classes, setClasses] = useState<LiveClass[]>(upcomingClasses);
  ...
  const getStatusBadge = (classItem: LiveClass) => {
    if (classItem.isLive) {
