...
interface EssayAssessmentDialogProps {
  open: boolean;
  onOpenChange: (open: boolean) => void;
}

export function EssayAssessmentDialog({ open, onOpenChange }: EssayAssessmentDialogProps) {
          ...
          <Tabs defaultValue="overview" className="w-full">
            ...
            <TabsContent value="options" className="space-y-6">
              ...
              <div className="space-y-4 pt-4 border-t">
                <h3 className="text-lg font-semibold">Grading Options</h3>
                
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <Label htmlFor="rubric" className="text-sm font-medium mb-2 block">
                      Grading Rubric
                    </Label>
                    <Select defaultValue="standard">
                      ...
                      <SelectContent>
                        <SelectItem value="standard">Standard Rubric</SelectItem>
                        <SelectItem value="custom">Custom Rubric</SelectItem>
                        <SelectItem value="holistic">Holistic Scoring</SelectItem>
                      </SelectContent>
                    </Select>
                  </div>
