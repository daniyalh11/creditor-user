...
export interface LessonModuleData {
  id: string;
  moduleId: string;
  title: string;
  description: string;
...
interface LessonCardModuleProps {
  lesson: LessonModuleData;
  className?: string;
}

export function LessonCardModule({ lesson, className }: LessonCardModuleProps) {
  return (
