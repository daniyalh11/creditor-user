...
export function ChatbotWidget() {
  ...
  // Focus input when chatbot is expanded
  useEffect(() => {
  ...
  if (isMobileView) {
    ...
    return (
      <Card className="border shadow relative">
        <div className="p-3 flex items-center justify-between border-b">
          <div className="flex items-center gap-2">
            <div className="bg-primary rounded-full p-1.5">
              <MessageSquare size={14} className="text-white" />
            </div>
            <h3 className="font-medium text-sm">Ask me anything</h3>
          </div>
          <Sheet>
  ...
  // Desktop view with fixed dimensions and proper positioning to prevent affecting other elements
  return (
    <div className="relative">
      <Card className="border shadow-md">
        <div className="p-3 flex items-center justify-between border-b">
          ...
          <Button variant="ghost" size="sm" onClick={toggleChatbot} className="h-6 w-6 p-0">
            {isExpanded ? <Minimize2 size={14} /> : <MessageSquare size={14} />}
          </Button>
        </div>
      ...
      {/* Chat Expanded Container - Positioned absolutely with higher z-index */}
      {isExpanded && (
        <div className="absolute top-0 right-0 z-50 w-full shadow-xl border rounded-md bg-background overflow-hidden" style={{ minHeight: '24rem' }}>
          <div className="p-3 flex items-center justify-between border-b sticky top-0 bg-background">
            ...
            <Button variant="ghost" size="sm" onClick={toggleChatbot} className="h-8 w-8 p-0">
              <X size={16} />
            </Button>
          </div>
