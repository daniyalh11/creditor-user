...
import { ChevronLeft, MessageSquare, Users, Clock, Send, ThumbsUp, ThumbsDown } from "lucide-react";
...
export function DebateView() {
  ...
  const [messages] = useState<DebateMessage[]>([
    {
      id: "1",
      author: "Sarah Johnson",
      message: "React Hooks provide a more functional approach to React development. They eliminate the need for class components and make code more reusable through custom hooks.",
    ...
    },
    {
      id: "2",
      author: "Mike Chen",
      message: "While hooks are useful, class components provide better lifecycle control and are more familiar to developers coming from OOP backgrounds. The learning curve for hooks can be steep.",
    ...
    },
    {
      id: "3",
      author: "Emily Davis",
      message: "Custom hooks allow for incredible code reusability. You can extract stateful logic and share it between components easily, which is much harder with class components.",
  ...
  const handleVote = (messageId: string, type: "like" | "dislike") => {
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <Card>
                ...
                <CardContent className="space-y-4 max-h-96 overflow-y-auto">
                  {forMessages.map((message) => (
                    <div key={message.id} className="bg-green-50 dark:bg-green-950/20 p-4 rounded-lg">
              ...
              <Card>
                ...
                <CardContent className="space-y-4 max-h-96 overflow-y-auto">
                  {againstMessages.map((message) => (
                    <div key={message.id} className="bg-red-50 dark:bg-red-950/20 p-4 rounded-lg">
                      <div className="flex items-start gap-3">
                        <Avatar className="w-8 h-8">
                          <AvatarImage src="/placeholder.svg" />
                          <AvatarFallback>{message.author.split(' ').map(n => n[0]).join('')}</AvatarFallback>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-3">
                  <Textarea
                    placeholder={`Share your argument ${selectedSide === "for" ? "supporting" : "opposing"} React Hooks...`}
                    value={newMessage}
