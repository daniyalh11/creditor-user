...
const generateProfessionalAvatarGrid = (count: number, baseColor: string, category: string, style: string): { id: string, src: string, alt: string, category: string }[] => {
...
export function AvatarPickerPage() {
  ...
  const [selectedAvatar, setSelectedAvatar] = useState<string>(getUserAvatarUrl());
  const [isLoading, setIsLoading] = useState<boolean>(true);
  const [activeTab, setActiveTab] = useState<"avatar" | "photo">("avatar");
  const [activeAvatarCategory, setActiveAvatarCategory] = useState<string>("male");
      ...
      <div className="container max-w-5xl mx-auto p-4 sm:p-6">
        ...
        <div className="mt-6">
          <Tabs 
            ...
            onValueChange={(value) => setActiveTab(value as "avatar" | "photo")}
            className="space-y-4"
          >
