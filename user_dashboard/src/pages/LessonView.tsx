...
export function LessonView() {
  ...
  const lessonData = lessonsDatabase[moduleId as keyof typeof lessonsDatabase]?.[lessonId as keyof typeof lessonsDatabase[keyof typeof lessonsDatabase]] || lessonsDatabase["2"]["2"];
