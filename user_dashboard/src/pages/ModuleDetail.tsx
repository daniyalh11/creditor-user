...
import { LessonCardModule, LessonModuleData } from "@/components/courses/LessonCardModule";
...
const moduleLessons: LessonModuleData[] = [
  {
    id: "1",
    moduleId: "2",
...
const moduleAssignments: AssignmentData[] = [
  {
    id: "assignment-1",
    moduleId: "2",
    lessonId: "1",
...
const isLessonLocked = (lessonIndex: number, lessons: LessonModuleData[]): boolean => {
...
export function ModuleDetail() {
  ...
  const [selectedDemoAssessment, setSelectedDemoAssessment] = useState<{title: string, type: string}>({title: "", type: ""});
  ...
  const handleAssessmentClick = (type: string) => {
  ...
  const handleJoinDebate = (debate: any) => {
  ...
  const handleContinueSurvey = (survey: any) => {
  ...
  const handleTryDemo = (assessmentTitle: string, assessmentType: string) => {
