...
export function QuizView() {
  ...
  const mode = searchParams.get('mode') || 'start'; // start, continue, review
  ...
  useEffect(() => {
    if (mode === 'continue') {
      ...
      setCurrentQuestion(1); // Mock: user was on question 2
      setSelectedAnswers({ "q1": "q1-b" }); // Mock: user had answered question 1
    } else if (mode === 'review') {
      // Show completed quiz for review
      setQuizCompleted(true);
      setScore(mockQuizData.lastScore);
      setSelectedAnswers({
        "q1": "q1-b",
        "q2": "q2-c", 
        "q3": "q3-a" // Mock: wrong answer for demonstration
      });
    }
  }, [mode]);
